...
def obs_frame_capture(match_id=1, access_token=None, camera_index=1):
    ...
    local_model = YOLO(resource_path('app/best.pt'))
...
def verify_weapon_with_sift(kill_block_folder, kill_type_from_api):
    ...
    api_weapons = [
        'molotov-kill', 'molotov-knockout', 'carblast-knockout', 'car-kill', 'grenade-knockout', 'grenade-kill','playzone-kill','playzone-knockout','self-knockout','self-kill','kill','carblast-kill','car-knockout',
        'gun-kill','gun-knock','gun-head-kill','gun-head-knock','player-kill','player-skill-kill','player-skill-knock','smoke-grenade-kill','smoke-grenade-knock','playzone-knock','falling-knock','revived','gun knockout'
    ]
