...
class CaptureThread:
    ...
    def get_frames_after(self, frame_num: int) -> list[BufferedFrame]:
        """All buffered frames newer than frame_num (FIFO order) — for burst catch-up."""
        with self._lock:
            return [bf for bf in self._ring if bf.frame_num > frame_num]
